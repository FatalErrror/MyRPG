...
public class SaveAndLoadAvatar {
    //=========== Поля данных =================
    final static String patch = "C:\\Users\\gruni\\IdeaProjects\\MyRPG\\src\\com\\company\\rpg\\Date.txt";// Расположения файла с данными
    ...
    */
    ...
    public static Avatar loadAvatar() {// Превращение массива строк в класс "Avatar"
        ...
        Avatar avatar = new Avatar(date[0], Race.valueOf(date[1]), Integer.parseInt(date[7]), Integer.parseInt(date[2]), Class.valueOf(date[3]), personaj);//Создание и инициализация объеката "Avatar"
    ...
    public static void saveAvatar(Avatar avatar) {// Превращение класса "Avatar" в массив строк
        String[] date = new String[8]; // Создание массива
    ...
    private static void WriteStream(String[] date) { // Запись данных из массива в файл
        ...
        try {//обработка исключений
            ...
            for (int i = 0; i < 8; i++) {//запись 7 строк
